...
Anyone can contribute to our samples, whether you are an IBMer or not.
...
If you would like to contribute your experience with our samples to the project in the form of encountered bug reports, necessary documentation changes, or new feature requests, this can be done through the use of the repository's [**Issues**](#) list.  
...
However, here's a compact guide on the suggested workflow
...
- Commits passing this stage will make it into the next release cycle for the project.
